...
- **Reusable workflow** — the workflow reads these ten names from repository
  ...
  `G2G_LOG_LEVEL`, `G2G_RESOLVE_PROJECT_VIA_GERRIT`, `G2G_NO_GERRIT` and
  `G2G_DISABLED`.
...
| `G2G_RESOLVE_PROJECT_VIA_GERRIT` | `false`                                     | Without a `.gitreview`, ask Gerrit which project a hyphenated GitHub name maps to |
