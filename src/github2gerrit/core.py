...
class Orchestrator:
    ...
    def _install_commit_msg_hook(self, gerrit: GerritInfo) -> None:
        ...
        try:
            ...
            _MSG_HOOK_NOT_CREATED = "commit-msg hook not created"
            ...
            # Execute curl and capture output/status for debugging
            result = run_cmd(curl_cmd, cwd=self.workspace)
            # Verify file was written
            if not hook_path.exists():
                _raise_orch(_MSG_HOOK_NOT_CREATED)
