...
class TestForceFlag:
    ...
    def test_abandoned_change_without_force_raises_error(
        ...
        """Test that abandoned changes raise error without force flag."""
        # Setup mocks
        ...
        assert "abandoned" in str(exc_info.value.message).lower()
        # Should not attempt to close PR
...
class TestContextAwareBehavior:
    ...
    def test_new_change_warns_but_proceeds(
        ...
        # Should proceed despite NEW status
        result = close_github_pr_for_merged_gerrit_change(
            "abc123de",
            gerrit_change_url=gerrit_url,
            force=False,
    ...
    def test_unknown_status_warns_but_proceeds(
        ...
        # Should proceed despite UNKNOWN status
        result = close_github_pr_for_merged_gerrit_change(
            "abc123de",
            gerrit_change_url=gerrit_url,
            force=False,
